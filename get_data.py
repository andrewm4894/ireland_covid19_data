...
for press_release_link in press_release_links:
    ...
    patterns = [
        ('There are now (.*) confirmed cases of COVID-19 in Ireland',
         'txt_cases'),
        ('There have now been (.*) COVID-19[ -]related deaths in Ireland',
         'txt_deaths'),
        ('informed of (.*) new confirmed cases',
         'txt_new_cases'),
        ('To date, (.*) tests have been carried out',
         'txt_tests'),
        ('today been informed that (.*) patients diagnosed with COVID-19 in Ireland have died',
         'txt_new_deaths'),
        ('median age of today’s reported deaths is (.*).',
         'txt_new_deaths_median_age'),
        ('median age of confirmed cases is (.*) years',
         'txt_cases_median_age'),
        ('(.*) cases .* have been hospitalised',
         'txt_cases_hospitalised'),
        ('cases (.*) have been hospitalised',
         'txt_cases_hospitalised_pct'),
        ('of those hospitalised, (.*) cases have been admitted to ICU',
         'txt_cases_admitted_icu'),
        ('(.*) cases are associated with healthcare workers',
         'txt_cases_healthcare_workers'),
        ('(.*) cases \(.*%\) are associated with healthcare workers',
         'txt_cases_healthcare_workers'),
        (' cases \((.*)\) are associated with healthcare workers',
         'txt_cases_healthcare_workers_pct'),
        ('.*% are male and (.*) are female',
         'txt_female_pct'),
        ('(.*) are male and .*% are female',
         'txt_male_pct'),
        ...
        ('Dublin has the highest number of cases at .* followed by Cork with .* cases (.*)',
         'txt_cases_cork_pct'),
        ('with (.*) clusters involving .* cases',
         'txt_clusters'),
        ('with .* clusters involving (.*) cases',
         'txt_clusters_cases'),
        ('(.*) deaths located in the east of the country',
         'txt_new_deaths_east'),
        ...
        ('(.*) new cases of COVID-19 in Ireland have been confirmed.',
         'txt_new_cases'),
        ('an additional (.*) new confirmed cases of COVID-19 reported by Irish laboratories',
         'txt_new_cases'),
        ('The Health Protection Surveillance Centre has today been informed that (.*) people diagnosed with COVID-19 in Ireland have died.',
         'txt_new_deaths'),
        ('the deaths included (.*) females and .* males',
         'txt_new_deaths_females'),
        ('the deaths included .* females and (.*) males',
         'txt_new_deaths_males'),
    ...
    rubbish_strings = [
        ...
        '4inthenorth-westand', 'laboratoryconfirmed', '2inthewest2inthenorth-westand', 'confirmed', 'atotal'
    ]
    replacements = [
        ('ten', '10'),
        ('nine', '9'),
